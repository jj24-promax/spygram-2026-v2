...
import { ArrowLeft, ArrowRight, Lightbulb, MessageSquare, CheckCircle, Clock, Eye } from 'lucide-react';
...
const QUESTION_ICONS: Record<string, React.ReactNode> = {
  q1: <Lightbulb size={36} />,
  q2: <MessageSquare size={36} />,
  q3: <Clock size={36} />,
  q4: <CheckCircle size={36} />,
  q5: <Eye size={36} />,
};
            ...
            {currentQuestion.options.map((option) => (
              <button
                ...
                className={cn(
                  ...
                  'bg-white/10 hover:bg-white/20 border border-white/5 transition-colors text-sm',
